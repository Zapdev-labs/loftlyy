...
export default function BrandsLayout({
  ...
  return (
    <div className="flex h-dvh bg-white dark:bg-neutral-950">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-50 focus:rounded-md focus:bg-white focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:shadow-lg dark:focus:bg-neutral-900"
      >
        Skip to content
      </a>
      <BrandSidebar />
